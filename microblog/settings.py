...
PROJECT_CORE_PATH = os.path.realpath(os.path.dirname(__file__))
PROJECT_PATH = os.path.realpath(os.path.join(os.path.dirname(__file__), os.path.pardir))
config.read(os.path.join(PROJECT_CORE_PATH,'settings.conf'))
...
SECRET_KEY = 'ufw_)5ra%*9hisxrove3z&amp;k5)m1xiod6h&amp;d98$(tcccd57ffm-'
